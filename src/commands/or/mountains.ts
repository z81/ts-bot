export default [
  { name: "Кула-Кангри", height: 7538, img: "" },
  { name: "Лупгхар-Шар", height: 7200, img: "" },
  {
    name: "Конгуртюбе",
    height: 7530,
    img:
  ...
  { name: "Дастогхил", height: 7884, img: "" },
  {
    name: "Нгади-Чули",
    height: 7871,
    img:
  ...
  { name: "Кунианг-Киш", height: 7823, img: "" },
  {
    name: "Машербрум",
    height: 7821,
    img:
  ...
  { name: "Камет (англ.)русск.", height: 7756, img: "" },
  {
    name: "Дхаулагири II",
    height: 7751,
    img:
  ...
  { name: "Моламенкинг", height: 7703, img: "" },
  {
    name: "Гурла-Мандхата",
    height: 7694,
    img:
  ...
  { name: "Сасер-Кангри I", height: 7672, img: "" },
  {
    name: "Чоголиза",
    height: 7665,
    img:
  ...
  { name: "Сингхи-Кангри", height: 7202, img: "" },
  {
    name: "Лхоцзе",
    height: 8516,
    img:
  ...
  { name: "Мамостонг-Кангри (англ.)русск.", height: 7516, img: "" },
  {
    name: "Сасер-Кангри II (англ.)русск.",
    height: 7513,
    img:
  ...
  { name: "Пумари-Киш", height: 7492, img: "" },
  {
  ...
  { name: "Юкшин-Гардан-Сар (англ.)русск.", height: 7469, img: "" },
  { name: "Терам Кангри I", height: 7462, img: "" },
  { name: "Джонгсонг", height: 7462, img: "" },
  { name: "Малубитинг", height: 7458, img: "" },
  {
    name: "Гангапурна",
    height: 7455,
    img:
  ...
  { name: "К12", height: 7428, img: "" },
  { name: "Янгра(Ганеш I)", height: 7422, img: "" },
  { name: "Sia Kangri", height: 7422, img: "" },
  { name: "Момхиль-Шар", height: 7414, img: "" },
  { name: "Kabru N", height: 7412, img: "" },
  { name: "Скил-Брум", height: 7410, img: "" },
  { name: "Харамош", height: 7409, img: "" },
  { name: "Istor-o-Nal", height: 7403, img: "" },
  { name: "Ghent Kangri", height: 7401, img: "" },
  { name: "Ултар", height: 7388, img: "" },
  { name: "Римо I", height: 7385, img: "" },
  { name: "Churen Himal", height: 7385, img: "" },
  { name: "Терам Кангри III", height: 7382, img: "" },
  { name: "Sherpi Kangri", height: 7380, img: "" },
  { name: "Labuche Kang", height: 7367, img: "" },
  { name: "Кират-Чули", height: 7362, img: "" },
  { name: "Abi Gamin", height: 7355, img: "" },
  { name: "Mana", height: 7272, img: "" },
  { name: "Дхаулагири VI", height: 7268, img: "" },
  { name: "Diran", height: 7266, img: "" },
  { name: "Labuche Kang III / East", height: 7250, img: "" },
  { name: "Putha Hiunchuli", height: 7246, img: "" },
  { name: "Apsarasas Kangri", height: 7245, img: "" },
  { name: "Mukut Parbat", height: 7242, img: "" },
  { name: "Rimo III", height: 7233, img: "" },
  { name: "Langtang Lirung", height: 7227, img: "" },
  { name: "Карджианг", height: 7221, img: "" },
  { name: "Аннапурна Южная", height: 7219, img: "" },
  { name: "Кхартапху", height: 7213, img: "" },
  { name: "Тонгшанджиабу", height: 7207, img: "" },
  { name: "Malangutti Sar", height: 7207, img: "" },
  { name: "Ноценкансари", height: 7206, img: "" },
  { name: "Лангтанг-Ри", height: 7205, img: "" },
  { name: "Кангпху-Канг", height: 7204, img: "" },
  {
    name: "Чогори",
    height: 8611,
    img:
